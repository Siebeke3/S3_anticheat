...
Config.whitelist = {
	'steam:uwid'              --Voor de anticheat whitelist ( admin )
}

Config.permissie        = "admin" --Voor het gebruik van Ban commands (mod-admin-superadmin)


Config.Discord				= 'https://discord.com/api/webhooks/969293513059618836/Nwkxu5q_qXCmHKPmcuhAranVGE7EFpxTqoyMj8C5TDQZrTYM2zdDFYUkM-ktPgBmw2kb'
Config.metdiscord = true -- Aanzetten als je logs wilt. (WEBHOOKS)
Config.webhookban        = ""
Config.webhookunban      = ""
Config.green             = 56108
Config.grey              = 8421504
...
Config.Objectenblacklist={
	...
	"p_gasmask_s",
	"prop_flamingo"
	-- Props kunnnen hieronder geadd worden op de blacklist ! 
}
